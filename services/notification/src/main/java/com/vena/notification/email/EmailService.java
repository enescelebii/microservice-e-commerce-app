package com.vena.notification.email;


import com.vena.notification.kafka.order.Product;
...
import static com.vena.notification.email.EmailTemplates.*;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(
        ...
        messageHelper.setFrom("ereseres1579@gmail.com");
        ...
        try {
            ...
            log.warn("WARNING: Failed to send email to {} with template {}", destinationEmail, templateName, e);
